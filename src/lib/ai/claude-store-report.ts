...
import type { PeriodMetric, StoreReportDigest } from "@/types/database";
...
9. Section 8: Insights and Actions for Next Week (Sales, Marketing, Customer Experience / Conversion, Inventory, Additional Priority)
10. Section 9: Closing Summary (one sentence)

Every numbered section from 2–7 must use:
...
Section 8 must give specific next-period actions tied to the figures, not generic advice.
...
- You should analyse patterns that ARE in the digest: volume vs value, strongest/weakest days, channel mix, new vs returning, traffic vs conversion, top products and referrers.
...
- Do not mention ShopifyQL, Admin API, scopes, CSVs, digests, AI, or internal tooling.
...
${metricLine("Total Sales", digest.sales.total_sales, "money", currency)}
...
${digest.channels.length ? "Channel sales for the week are listed below." : "Sales by channel were not available this week."}
